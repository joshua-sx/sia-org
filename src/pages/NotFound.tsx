...
const NotFound = () => (
  <>
    ...
    <div className="relative flex min-h-screen items-center justify-center bg-surface px-4 py-12">
      ...
      />
      <div className="relative w-full max-w-md rounded-2xl border border-hairline bg-surface-raised p-8 text-center shadow-[0_1px_2px_rgba(0,0,0,0.04),0_8px_24px_-8px_rgba(0,0,0,0.08)]">
        <div className="mb-6 flex justify-center">
          <BrandMark />
        </div>
        <p className="text-sm font-medium uppercase tracking-wide text-ink-muted">404</p>
        <h1
          className="mt-2 text-2xl font-semibold tracking-tight text-ink-strong"
