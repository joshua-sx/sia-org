...
import ParticipantAssessmentDetail from "./pages/ParticipantAssessmentDetail";
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/appraisals/assessments/:participantId" element={<ProtectedRoute><AppLayout><ParticipantAssessmentDetail /></AppLayout></ProtectedRoute>} />
